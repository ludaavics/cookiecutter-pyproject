...
from {{cookiecutter.project_import_name}} import __version__  # noqa
...
{%
  set main_python_version = cookiecutter.minimum_python_version.split('.')[:2]
    | join('.')
%}
intersphinx_mapping = {
    "python": ("https://docs.python.org/{{main_python_version}}/", None),
}
